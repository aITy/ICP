...
**
** Created: Thu 9. May 01:36:59 2013
...
static const char qt_meta_stringdata_GameBoard[] = {
    "GameBoard\0\0refresh()\0,\0showMoves(uint,uint)\0"
    "srcx,srcy,destx,desty\0"
    "sceneUpdate(uint,uint,uint,uint)\0"
    "toutExpired()\0"
};
...
void *GameBoard::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "Ui::Form_Board"))
        return static_cast< Ui::Form_Board*>(const_cast< GameBoard*>(this));
...
int GameBoard::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: showMoves((*reinterpret_cast< uint(*)>(_a[1])),(*reinterpret_cast< uint(*)>(_a[2]))); break;
        case 2: sceneUpdate((*reinterpret_cast< uint(*)>(_a[1])),(*reinterpret_cast< uint(*)>(_a[2])),(*reinterpret_cast< uint(*)>(_a[3])),(*reinterpret_cast< uint(*)>(_a[4]))); break;
        case 3: toutExpired(); break;
        default: ;
        }
        _id -= 4;
    }
